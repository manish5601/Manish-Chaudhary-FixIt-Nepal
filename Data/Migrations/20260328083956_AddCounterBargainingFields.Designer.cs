...
namespace FixItNepal.Data.Migrations
{
    ...
    [Migration("20260328083956_AddCounterBargainingFields")]
    partial class AddCounterBargainingFields
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FixItNepal.Models.Dispute", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FixItNepal.Models.Review", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FixItNepal.Models.ChatMessage", b =>
                {
                    b.HasOne("FixItNepal.Models.Booking", "Booking")
                        .WithMany()
                        .HasForeignKey("BookingId");

                    b.HasOne("FixItNepal.Models.ApplicationUser", "Receiver")
                        .WithMany()
                        .HasForeignKey("ReceiverId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("FixItNepal.Models.ApplicationUser", "Sender")
                        .WithMany()
            ...
            modelBuilder.Entity("FixItNepal.Models.Dispute", b =>
                {
                    ...
                    b.HasOne("FixItNepal.Models.ApplicationUser", "RaisedBy")
                        .WithMany()
            ...
            modelBuilder.Entity("FixItNepal.Models.Review", b =>
                {
                    b.HasOne("FixItNepal.Models.Booking", "Booking")
                        .WithOne("Review")
                        .HasForeignKey("FixItNepal.Models.Review", "BookingId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
