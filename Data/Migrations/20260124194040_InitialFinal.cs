        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { Guid.NewGuid().ToString(), Guid.NewGuid().ToString(), "Customer", "CUSTOMER" },
                    { Guid.NewGuid().ToString(), Guid.NewGuid().ToString(), "ServiceProvider", "SERVICEPROVIDER" }
                });

            migrationBuilder.Sql("SET IDENTITY_INSERT ServiceCategories ON;");
            migrationBuilder.Sql("INSERT INTO ServiceCategories (Id, Name, Description, IsActive) VALUES (1, 'Plumbing', 'Pipe repairs, installation, leakage fixing.', 1);");
            migrationBuilder.Sql("INSERT INTO ServiceCategories (Id, Name, Description, IsActive) VALUES (2, 'Electrical', 'Wiring, appliance repair, installation.', 1);");
            migrationBuilder.Sql("INSERT INTO ServiceCategories (Id, Name, Description, IsActive) VALUES (3, 'Cleaning', 'Home and office deep cleaning services.', 1);");
            migrationBuilder.Sql("INSERT INTO ServiceCategories (Id, Name, Description, IsActive) VALUES (4, 'Moving', 'Packing and moving services.', 1);");
            migrationBuilder.Sql("INSERT INTO ServiceCategories (Id, Name, Description, IsActive) VALUES (5, 'Painting', 'Wall painting and decorations.', 1);");
